...
function ProductDetailPage() {
  ...
  const productInfoRows = useMemo(() => {
    ...
    return [
      ...
      { label: 'Amount without Stones', value: product.amountWithoutStones ? formatCurrency(product.amountWithoutStones) : 'N/A' },
      { label: 'Stone Amount', value: product.stoneAmount ? formatCurrency(product.stoneAmount) : 'N/A' },
      { label: 'Gold Value', value: product.amountWithoutGst ? formatCurrency(product.amountWithoutGst) : 'N/A' },
      { label: `GST (${product.gstPercentage || 0}%)`, value: product.gstAmount ? formatCurrency(product.gstAmount) : 'N/A' },
      { label: 'Total Price', value: product.basePrice ? formatCurrency(product.basePrice) : 'N/A' },
      {
        label: 'Collection',
